...
* 
*   From Rendering Course by Károly Zsolnai-Fehér and Thomas Auzinger:
*   . Ray Tracing computes the intensity, an approximation to light computation (#14)
*     I = Ambient + Diffuse + Specular + Refraction +  Reflection
*     I = Ka Ia + Ii (Kd (L . N) + Ks (V . R)^n) + Kt It + Kr Ir
*     L - light source direction
*     N - normal
*     V - view direction
*     R - reflection vector
*   Links to 2015 course:
...
*   New 2021 version of the rendering course: https://www.cg.tuwien.ac.at/courses/Rendering/VU
**/
#include <cstring>
#include <string>
#include <vector>
...
static char* WINDOW_TITLE_PREFIX = "Simple Ray Tracer";
